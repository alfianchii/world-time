...
<template>
	<div relative>
		...
		<div v-show="input" absolute top-full left-0 right-0 z-10 border="~ base rounded" shadow bg-base max-h-100 overflow-auto>
			<button v-for="(i, idx) of searchResult" :key="i.refIndex" block w-full px2 @click="add(i.item)" :class="idx === index ? 'bg-gray:10' : ''">
